...
///方案二 IndexedStack实现状态保存(推荐)
class HomePageIndexStack extends StatefulWidget {
  HomePageIndexStack({Key key}) : super(key: key);
  ...
  @override
  _HomePageIndexStack createState() => _HomePageIndexStack();
}

class _HomePageIndexStack extends State<HomePageIndexStack> {
  final  titleStr="IndexStack";
